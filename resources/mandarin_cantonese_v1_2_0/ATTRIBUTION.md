...
## v1.2.0 structural migration

The generated sentence Cartesian products were removed from runtime phrases and
replaced by typed templates and slot metadata. Existing source attribution and
share-alike obligations remain unchanged.
