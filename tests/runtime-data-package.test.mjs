...
test("latest runtime data package passes manifest and validation checks", () => {
  ...
  assert.equal(manifest.counts.translation_units, 1302);
  ...
  assert.equal(runtimeCore.slot_types.length, manifest.counts.slot_types);
  assert.equal(runtimeCore.slot_values.length, manifest.counts.slot_values);
